          ...
          children: [
            ...
            if (!isLoading && restoranLocation != null)
              Padding(
                ...
                child: SizedBox(
                  height:
                      300, // Berikan batas tinggi agar tidak memakan seluruh layar
                  child: GoogleMap(
            ...
            // Tambahkan judul ulasan restoran dengan padding
            const Padding(
            ...
            Column(
              children: [
                RPReviewCard(
                  ...
                  rating: 4.5,
                  ulasan:
                      'Tempatnya nyaman, makanannya enak, dan harganya terjangkau.',
                ),
                RPReviewCard(
                  nama: 'Jane Doe',
                  rating: 5.0,
                  ulasan:
                      'Pelayanannya ramah, makanannya enak, dan tempatnya bersih.',
                ),
              ],
            ),
          ],
